...
console.log(exercise.three(str));
...
var obj = {'first_name': 'Erick', 'last_name': 'Ruiz'};

console.log(exercise.five(obj));
...
console.log(exercise.eight('1234'));
